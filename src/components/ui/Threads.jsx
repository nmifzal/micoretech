...
const Threads = ({
  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      const resizeRef = resize;
      const moveRef = handleMouseMove;
      const leaveRef = handleMouseLeave;
      ...
      return () => {
        ...
        if (enableMouseInteraction) {
          container.removeEventListener("mousemove", moveRef);
          container.removeEventListener("mouseleave", leaveRef);
        }
