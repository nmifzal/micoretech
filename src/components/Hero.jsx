...
const Hero = () => {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-gradient-to-br from-white via-mi-light/30 to-blue-50/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            Fast, Friendly Tech Support for <span className="text-mi-blue">Home Users</span>
          </motion.h1>
          ...
          >
            Resolution of your everyday tech headaches—from slow computers to Wi-Fi woes—all from the comfort of your home.
          </motion.p>
